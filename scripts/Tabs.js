...
class Tabs extends BaseComponent {
  selectors = {
    root: rootSelector, button: '[data-js-tabs-button]', content: '[data-js-tabs-content]',
  }
  ...
  stateAttributes = {
    ariaSelected: 'aria-selected', tabIndex: 'tabindex',
  }
  ...
  onKeyDown = (event) => {
    ...
    const action = {
      ArrowLeft: this.previousTab, ArrowRight: this.nextTab, Home: this.firstTab, End: this.lastTab,
    }[code]
